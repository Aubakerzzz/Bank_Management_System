...
public class GUI {
	...
	void open_Signup_form_1(JFrame frame, Login_Account user)
	{
		...
		btn_Verify_Account.setForeground(Color.BLACK);
	...
	void openClientMenu(JFrame frame, Client client, Bank_Account account) {
		...
		btnAccInfo.setForeground(Color.BLACK);
		f.add(btnAccInfo);
		...
		btnCCWithdrawal.setForeground(Color.BLACK);
		...
		btnEStatement.setForeground(Color.BLACK);
		f.add(btnEStatement);
	...
	void open_cardless_page_1(JFrame frame, Client client, Bank_Account account)
	{
		...
		btn_create_cardless_entry.setForeground(Color.BLACK);
		...
		btn_mm.setForeground(Color.BLACK);
	...
	void openTransferMoneyForm(JFrame frame, Client client, Bank_Account account) {
		...
		btn_Transfer.setForeground(Color.BLACK);
	...
	void openManagerMenu(JFrame frame, Manager manager) {
		...
		btnBlockAcc.setForeground(Color.BLACK);
		f.add(btnBlockAcc);
		...
		btnCloseAcc.setForeground(Color.BLACK);
		f.add(btnCloseAcc);
		...
		btnSearchAcc.setForeground(Color.BLACK);
		f.add(btnSearchAcc);
		...
		btnManageCard.setForeground(Color.BLACK);
		f.add(btnManageCard);
		...
		btnUpdateInfo.setBounds(550,250,150, 40);
	...
	public void openCreateAccountForm(JFrame frame, Manager manager) {
		...
		btn_sign_out.setBackground( new Color(0, 204, 153) );
		btn_sign_out.setForeground(Color.BLACK);
		btn_sign_out.setBounds(350,600,100, 30);
		f.add(btn_sign_out);
	...
	void open_manage_card_page(JFrame frame, Manager manager)
	{
		...
		btn_block_card.setForeground(Color.BLACK);
		...
		btn_unblock_card.setForeground(Color.BLACK);
	...
	void open_block_unblock_account_page(JFrame frame, Manager manager)
	{
		...
		btn_block_account.setForeground(Color.BLACK);
		...
		btn_unblock_account.setForeground(Color.BLACK);
		...
		JButton btn_mm = new JButton("Main Menu");
		btn_mm.setBackground( new Color(0, 204, 153) );
		btn_mm.setForeground(Color.ORANGE);
		btn_mm.setBounds(50,400,100, 30);
		f.add(btn_mm);
		...
		JButton btn_sign_out = new JButton("Sign Out");
		btn_sign_out.setBackground( new Color(0, 204, 153) );
		btn_sign_out.setForeground(Color.ORANGE);
		btn_sign_out.setBounds(650,30,100, 30);
		f.add(btn_sign_out);
	...
	void open_close_account_page(JFrame frame, Manager manager)
	{
		...
		btn_close_account.setForeground(Color.black);
	...
	void openAccountantMenu(JFrame frame, Accountant accountant) {
		...
		btnChequeDeposit.setForeground(Color.BLACK);
